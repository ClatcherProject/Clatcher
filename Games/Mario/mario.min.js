...
"title";this.Images[14].name="worldMap";this.Images[0].src="/Games/Mario/images/bgsheet.png";this.Images[1].src="/Games/Mario/images/endscene.gif";this.Images[2].src="/Games/Mario/images/enemysheet.png";this.Images[3].src="/Games/Mario/images/firemariosheet.png";this.Images[4].src="/Games/Mario/images/font.gif";this.Images[5].src="/Games/Mario/images/gameovergost.gif";this.Images[6].src="/Games/Mario/images/itemsheet.png";this.Images[7].src="/Games/Mario/images/logo.gif";this.Images[8].src="/Games/Mario/images/mapsheet.png";this.Images[9].src="/Games/Mario/images/mariosheet.png";this.Images[10].src="/Games/Mario/images/particlesheet.png";
this.Images[11].src="/Games/Mario/images/racoonmariosheet.png";this.Images[12].src="/Games/Mario/images/smallmariosheet.png";this.Images[13].src="/Games/Mario/images/title.gif";this.Images[14].src="/Games/Mario/images/worldmap.png";Enjine.Resources.AddImages(this.Images);(new Audio).canPlayType("audio/mp3")?Enjine.Resources.AddSound("1up","/Games/Mario/sounds/1-up.mp3",1).AddSound("breakblock","/Games/Mario/sounds/breakblock.mp3").AddSound("bump","/Games/Mario/sounds/bump.mp3",4).AddSound("cannon","/Games/Mario/sounds/cannon.mp3").AddSound("coin","/Games/Mario/sounds/coin.mp3",5).AddSound("death","/Games/Mario/sounds/death.mp3",
1).AddSound("exit","/Games/Mario/sounds/exit.mp3",1).AddSound("fireball","/Games/Mario/sounds/fireball.mp3",1).AddSound("jump","/Games/Mario/sounds/jump.mp3").AddSound("kick","/Games/Mario/sounds/kick.mp3").AddSound("pipe","/Games/Mario/sounds/pipe.mp3",1).AddSound("powerdown","/Games/Mario/sounds/powerdown.mp3",1).AddSound("powerup","/Games/Mario/sounds/powerup.mp3",1).AddSound("sprout","/Games/Mario/sounds/sprout.mp3",1).AddSound("stagestart","/Games/Mario/sounds/stagestart.mp3",1).AddSound("stomp","/Games/Mario/sounds/stomp.mp3",2):Enjine.Resources.AddSound("1up","/Games/Mario/sounds/1-up.wav",1).AddSound("breakblock","/Games/Mario/sounds/breakblock.wav").AddSound("bump",
"/Games/Mario/sounds/bump.wav",2).AddSound("cannon","/Games/Mario/sounds/cannon.wav").AddSound("coin","/Games/Mario/sounds/coin.wav",5).AddSound("death","/Games/Mario/sounds/death.wav",1).AddSound("exit","/Games/Mario/sounds/exit.wav",1).AddSound("fireball","/Games/Mario/sounds/fireball.wav",1).AddSound("jump","/Games/Mario/sounds/jump.wav",1).AddSound("kick","/Games/Mario/sounds/kick.wav",1).AddSound("message","/Games/Mario/sounds/message.wav",1).AddSound("pipe","/Games/Mario/sounds/pipe.wav",1).AddSound("powerdown","/Games/Mario/sounds/powerdown.wav",1).AddSound("powerup","/Games/Mario/sounds/powerup.wav",1).AddSound("sprout","/Games/Mario/sounds/sprout.wav",1).AddSound("stagestart",
"/Games/Mario/sounds/stagestart.wav",1).AddSound("stomp","/Games/Mario/sounds/stomp.wav",1);Mario.Tile.LoadBehaviors()};Mario.LoadingState.prototype.Exit=function(){delete this.Images};
